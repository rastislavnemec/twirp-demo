...
/**
 * A Protobuf client that implements the {@see Stock} interface.
 ...
 */
final class StockClient implements Stock
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function ReservationCreate(array $ctx, \Footshop\ReservationCreateRequest $in): \Footshop\ReservationCreateResponse
    {
        ...
        $out = new \Footshop\ReservationCreateResponse();

        $url = $this->addr.'/twirp/footshop.Stock/ReservationCreate';
